...
\newpage
\include{sections/section_1} % Introduction
\newpage
\include{sections/section_2} % Related Work
\newpage
\include{sections/section_3} % NEL
\newpage
\include{sections/section_4} % Features
\newpage
\include{sections/section_5} % Preprocessing
\newpage
\include{sections/section_6} % Evaluation
\newpage
\include{sections/section_7} % Conclusion
\newpage
